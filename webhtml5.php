...
<a class="navbar-link" href="#">سلة التسوق </a>
</il>
       </ul>
               ...
               <div class="col-lg-12 col-sm-12 hero-feature">
                   <div class="table-responsive">
                       <table class="table table-bordered tbl-cart">
                           <thead>
                               <tr>
                                   <td class="hidden-xs">صورة المنتج</td>
                                   <td>اسم المنتج</td>
                                   <td>حجم المطلوب</td>
                                   <td>اللون</td>
                                   <td class="td-qty">الكمية</td>
                           ...
                           <tbody>
                               <tr>
                                   <td class="hidden-xs">
                                       <a href="#">
                                           <img src="https://a.top4top.io/p_1782h1r1r0.jpeg" alt="webhtml3.html" title="" width="47" height="47">
                                       </a>
                                   </td>
                                   <td><a href="#">webhtml3.html</a>
                                   </td>
                                   <td>
                                       <select name="ساعة نسائية3">
                                   ...
                                   <td class="price">$ 122.21  ريا ل </td>
                                   <td>$ 122.21</td>
                               ...
                               <tr>
                                   <td class="hidden-xs">
                                       <a href="#">
                                           <img src="https://b.top4top.io/p_1783mzxhw0.jpeg" alt="webhtml4.html" title="" width="47" height="47">
                                       </a>
                                   </td>
                                   <td><a href="#">webhtml4.html</a>
                                   </td>
                                   <td>
                                       <select name="">
